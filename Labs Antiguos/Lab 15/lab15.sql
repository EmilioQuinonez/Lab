...
/* Hacer una consulta de los materiales en donde su impuesto sea menor a 55. */
SELECT * 
FROM materiales 
WHERE impuesto < 55;

/* Selecciona todos los materiales que fueron entregados en el proyecto Construcción de Hospital Infantil. */
